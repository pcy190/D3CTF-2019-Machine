...
public class ElfType32{
	...
	public elf32_hdr hdr;//elf??????
	public ArrayList<elf32_sym> symList = new ArrayList<elf32_sym>();
	public ArrayList<elf32_phdr> phdrList = new ArrayList<elf32_phdr>();//??????ж???????
	public ArrayList<elf32_shdr> shdrList = new ArrayList<elf32_shdr>();//??????ж?????
	public ArrayList<elf32_strtb> strtbList = new ArrayList<elf32_strtb>();//??????ж????????
